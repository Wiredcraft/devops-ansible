...
# Dirty rip of ansible playbook, but allow ssh password to be passed
# as argument to the command (same pass for sudo if any)
...
def main(args):
    ...
    parser.add_option('-p', '--ssh-pass', dest="remote_pass", default=None,
        help="allow passing the ssh password directly from the CLI")
    ...
    for playbook in args:
        ...
        pb = ansible.playbook.PlayBook(
            ...
            remote_pass=sshpass or options.remote_pass,
            ...
            sudo_pass=sudopass or options.remote_pass,
